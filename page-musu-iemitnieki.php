...
<div id="menu-animal">
    <button class="btn active" onclick="filterSelection('all')">Visi</button>
    <button class="btn" onclick="filterSelection('zirnekli')">Zirnekļveidīgie</button>
    <button class="btn" onclick="filterSelection('kukaini')">Kukaiņi</button>
    <button class="btn" onclick="filterSelection('putni')">Putni</button>
    <button class="btn" onclick="filterSelection('rapuli')">Rāpuļi</button>
    <button class="btn" onclick="filterSelection('abinieki')">Abinieki</button>
    <button class="btn" onclick="filterSelection('zivis')">Zivis</button>
</div>
